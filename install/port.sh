...
sudo port install -bcqN zola hexyl hurl dua-cli onefetch ouch tokei asciinema rustscan zellij yadm
...
sudo port install -bcqN openjdk8-zulu openjdk17-zulu maven3 maven_select gradle gradle-completion sbt scala2.11 scala2.11-docs scala2.12 scala2.12-docs scala2.13 scala2.13-docs scala_select
