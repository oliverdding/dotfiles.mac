...
link ".local/share/brew/etc/profile.d/10-paths.sh"
link ".local/share/brew/etc/profile.d/30-toolsets.sh"
link ".local/share/brew/etc/profile.d/50-program.sh"
link ".local/share/brew/etc/profile.d/99-eval.sh"
link ".local/share/brew/etc/profile"
